...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-10 text-text-primary">
      <motion.div
        initial={{ y: 24, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        className="site-panel w-full max-w-md p-8"
      >
        ...
        <div className="mt-6 flex flex-col gap-2 text-sm text-text-secondary">
          <Link to={ACTIVE_HOME_PATH} className="hover:text-accent-gold">
            ← Back to storefront
          </Link>
