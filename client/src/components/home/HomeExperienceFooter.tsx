...
export default function HomeExperienceFooter() {
  ...
  return (
    <footer className="relative bg-[#050403] text-[#F5EDD6]">
      <div
        className="relative border-t border-white/10 px-6 py-16 md:px-12"
        style={{
          backgroundImage: `linear-gradient(rgba(5,4,3,0.88), rgba(5,4,3,0.94)), url(${EXPERIENCE_TEXTURES.glassRoughness})`,
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          <p className="text-[10px] uppercase tracking-[0.4em] text-[#D4AF37]/70">Bukhari Perfumes</p>
